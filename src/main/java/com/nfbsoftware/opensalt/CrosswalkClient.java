...
/**
 * This is a Java utility class that is used to communicate with the Academic
 * Benchmarks' RESTful API.
 * 
...
public class CrosswalkClient
{
	 ...
	 * @param clientSecret      - The client secret issued by the authentication
	 *                          source
	...
	/**
	 * <p>
	 * This method will use the credentials entered previously to request a new
	 * access token
	 * </p>
	 * 
	 * @throws Exception - catch all for exceptions
	...
	/**
	 * <p>
	 * Gets item matches in the target framework of an item identified by
	 * identifier.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Gets item matches in the target framework of an item with a specific Human
	 * Coding Scheme in the source framework.
	 * </p>
	 * 
	 * @param source - The identifier, uri, or alias of the source framework
	 * @param hcs    - The Human Coding Scheme of the item in the source framework
	 *               to match
	 * @param target - The identifier of the target framework
	 * @return An instance of PCGCrosswalk
	 * @throws Exception - catch all for exceptions
	...
	/**
	 * 
	 * @param sourceId guid identifying the standard
	 * @return An instance of the full standard
	 * @throws IOException             - catch all for exceptions
	 * @throws ClientProtocolException - catch all for exceptions
	 * @throws JsonParseException      - catch all for exceptions
	 * @throws JsonMappingException    - catch all for exceptions
	 */
